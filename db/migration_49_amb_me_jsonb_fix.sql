-- ============================================================
-- Migration 49: fix amb_me (COALESCE json vs jsonb)
-- ============================================================
...
begin
  ...
  return jsonb_build_object(
    ...
    'withdrawals', coalesce((
      select json_agg(json_build_object('id', w.id, 'amount', w.amount, 'status', w.status, 'note', w.note, 'created_at', w.created_at, 'decided_at', w.decided_at) order by w.created_at desc)::jsonb
