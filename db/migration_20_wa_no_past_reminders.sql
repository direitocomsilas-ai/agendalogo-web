-- MIGRATION 20 — não envia lembretes cujo horário programado já passou
...
begin
  ...
  -- lembretes com horário programado no passado não têm valor
  if p_type like 'lembrete%' and p_scheduled < now() then return; end if;
